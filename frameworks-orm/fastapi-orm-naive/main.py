#!/usr/bin/env python3
"""
Naive FastAPI REST ORM Implementation
Async REST API that demonstrates N+1 query problems with lazy loading instead of eager loading.
"""
...
async def get_user_posts(
    ...
    # NAIVE: Always use lazy loading - no eager loading!
    stmt = select(Post).where(Post.author_id == user_id).limit(limit)
